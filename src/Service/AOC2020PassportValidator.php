...
class AOC2020PassportValidator
{
    ...
    {
        return preg_match($this::FOUR_DIGITS_REGEXP , $data) && ((int)$data >= 1920 && (int)$data <= 2002);
    }

    // iyr (Issue Year) - four digits; at least 2010 and at most 2020.
    public function IYRValidator(string $data): bool
    {
        return preg_match($this::FOUR_DIGITS_REGEXP , $data) && ((int)$data >= 2010 && (int)$data <= 2020);
    }

    // eyr (Expiration Year) - four digits; at least 2020 and at most 2030.
    public function EYRValidator(string $data): bool
    {
        return preg_match($this::FOUR_DIGITS_REGEXP , $data) && ((int)$data >= 2020 && (int)$data <= 2030);
    }
